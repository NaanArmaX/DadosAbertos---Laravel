...
@section('content')
    <div class="container">
        <h1>Deputados do Partido {{ $partido }}</h1>
        ...
        <table>
            ...
            <tbody>
                @forelse($deputados as $dep)
                    <tr onclick="window.location='{{ route('deputados.show', $dep->id) }}'">
                        <td>
                ...
                @empty
                    <tr>
                        <td colspan="3">Nenhum deputado encontrado.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
